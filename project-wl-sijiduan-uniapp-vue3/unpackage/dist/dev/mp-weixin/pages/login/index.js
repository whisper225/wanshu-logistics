  ...
  setup(__props) {
    ...
    const handleWxLogin = () => {
      ...
      common_vendor.index.login({
        ...
        success: (loginRes) => {
          ...
          pages_api_login.wxLogin({ code: loginRes.code, role: "driver" }).then((data) => {
            ...
            common_vendor.index.switchTab({ url: "/pages/transport/index" });
          }).catch((err) => {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        b: loading.value,
        c: common_vendor.o(handleWxLogin, "f9")
      };
    };
  }
};
