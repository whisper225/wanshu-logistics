...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__COURIER01",
    appName: "wanshu-courier",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "192.168.23.1,192.168.150.1,10.159.5.15,127.0.0.1,192.168.32.1,172.28.32.1";
  const port = "8090";
  const id = "mp-weixin_ySfBUz";
